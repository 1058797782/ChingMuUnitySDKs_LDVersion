...
[ChingMu SDK for Unity 3.0](https://github.com/ChingMuVisionTech/ChingMuUnitySDKs/releases/download/v3.0.0/CMUnitySDK3.0.unitypackage)
[插件帮助文档](https://github.com/ChingMuVisionTech/ChingMuUnitySDKs/releases/download/v3.0.0/default.docx)

### 1 引言

（1）ChingMu SDK for Unity 3.0插件提供了青瞳动捕在Unity中的各种功能API接口。<br>
（2）ChingMu SDK for Unity 3.0插件支持Unity2021及以上版本。
